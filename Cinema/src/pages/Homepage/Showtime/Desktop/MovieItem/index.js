      ...
      <div className="film">
        ...
        <div className="film__content">
          ...
          {/* <div className={`film__button`}>
            {(thoiLuong || comingMovie) && <Link style={{ background: comingMovie ? "#60c5ef" : "rgb(238, 130, 59)", }} to={{ pathname: `/detail/${movie.maPhim}`, state: { comingMovie } }}>{comingMovie ? "THÔNG TIN PHIM" : "Chi tiết phim"}</Link>}
          </div> */}
        </div>
      </div>
    </div>
