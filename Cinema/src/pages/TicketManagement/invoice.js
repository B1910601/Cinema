...
const Invoice = () => {
  ...
  return (
    <>
        ...
        <tbody>
          <tr>
            <td style={{ backgroundColor: "#ffffff", padding: "40px 30px" }}>
              <h3 style={{ textAlign: "center" }}>Vé Xem Phim</h3>
              ...
              {datVeDaDat && (
                <>
                  <div className="text-left">
                    <p>
                      <b>Tên khách hàng:</b> {datVeDaDat[0].tenTaiKhoan}
                    </p>
                    <p>
                      <b>Cụm Rạp:</b> {datVeDaDat[0].tenCumRap}
                    </p>
                    <p>
                      <b>Địa Chỉ:</b> {datVeDaDat[0].diaChi}
                    </p>
                    <p>
                      <b>Rạp chiếu:</b> {datVeDaDat[0].tenRap}
                    </p>
                    <p>
                    ...
                    <p>
                      <b>Loại ghế:</b> {datVeDaDat[0].loaiGhe}
                    </p>
                  </div>
                  <hr />
                  <table
      ...
      <button style={{ margin: " 20px 20px 20px 20px" }} className="btn btn-success" onClick={handlePrint}>In vé</button>
    </>
