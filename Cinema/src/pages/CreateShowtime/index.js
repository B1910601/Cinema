...
export default function MoviesManagement() {
    ...
    const handleDeleteOne = (maLichChieu) => {
        usersApi.getDanhSachVeDaDatTheoLichChieu(maLichChieu).then((result) => {
            setData(result.data);
            console.log("lich chieu", result.data);
            ...
            if (flag) {
                ...
                alert("Lịch chiếu không thể xóa vì vé chưa được xác thực!!!");
            }
        });
