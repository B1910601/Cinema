    ...
    return (
        <div className="container rounded mb-5">
            <div className="row bg-white" >
                ...
                {/* <div style={{ marginTop: "40px" }} className="col-md-2">
                ...
                <div className="col-md-16" style={{ width: isMobile ? "100%" : "calc(100% - 100px)" }}>
                    <table className="table">
                        <thead>
                            ...
                            <th>Loại ghế</th>
                            <th>Giá vé</th>
                            <th style={{ width: isMobile ? "100%" : "calc(100% - 100px)" }}>Trạng Thái</th>
                        </thead>
                        <tbody>
