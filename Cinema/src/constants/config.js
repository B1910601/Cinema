...
export const HIDDEN_SEARCHTICKET = "(max-width:calc(100% - 255px))";
export const DISPLAY_MOBILE_HOMEPAGE = "(max-width:calc(100% - 736px))";
export const IMG_LOADING = "/img/logoTixLoading.png";

export const DATE_BEGIN_DANGCHIEU = "2020-12-01"; // format: yyyy-mm-dd
export const DATE_END_DANGCHIEU = "2020-12-01";

export const DATE_BEGIN_SAPCHIEU = "2020-12-01";
