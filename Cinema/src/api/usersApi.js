...
const usersApi = {
    ...
    getDanhSachVeDaDatTheoLichChieu: (maLichChieu) => {
        const path = `/QuanLyDatVe/LayDanhSachVeDuaTheoLichChieu?maLichChieu=${maLichChieu}`;
        return axiosClient.get(path);
    },
    getDanhSachCumRap: (maCumRap) => {
        const path = `/QuanLyDatVe/LayDanhSachVeDuaTheoCumRap?maCumRap=${maCumRap}`;
        return axiosClient.get(path);
    },
    ...
    getCumRap: () => {
        const path = "ThongKe/getCumrap";
        return axiosClient.get(path);
    },
    deleteTicketOfUser: (maGhe) => {
        const path = `/DeleteTicketOfUser?maGhe=${maGhe}`;
        return axiosClient.delete(path)
    },
    getDanhSachVe: (maGhe) => {
         const path = `/QuanLyDatVe/LayDanhSachVeDuaTheoVe?maGhe=${maGhe}`;
         return axiosClient.get(path);
     },
};
